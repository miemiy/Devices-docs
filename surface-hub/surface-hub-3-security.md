...
description: Discover security best practices for Surface Hub running Microsoft Teams Rooms on Windows, including password changes, UEFI setup, and physical security.
...
| **Audit and monitoring**          | Regularly review audit logs and set up alerts for suspicious activities. Intune integrates with other Microsoft security solutions, providing a holistic view of device security.                                                                     | [Audit changes and events in Microsoft Intune](/mem/intune/fundamentals/monitor-audit-logs)                                                                                                                                               |
